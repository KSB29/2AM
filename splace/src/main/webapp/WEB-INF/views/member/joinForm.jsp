										...
										<section class="join_right col-7">
											<form action="join.sp" method="POST">
												<article class="join_box_1">
													...
													<div class="join_form_box fileds center">
														...
														<div class="form_box  filed">
															<div class="form_btn ">
																<input type="email" id="memberId" name="memberId" placeholder="이메일" required>
															</div>
															<div class="form_box form_btn">
																<button id="checkId" class="button fit">중복 확인</button>
															</div> 
															<div class="noticeSpan3"></div>
														</div>
														...
														<div class="form_box filed">
															...
															<div class="form_box form_btn">
																<button class="button fit">인증 번호</button>
															</div>
														...
														<div class="form_box filed">
															<input type="text" id="memberPhone" name="memberPhone" placeholder="전화번호 입력" required>
															<span class ="noticeSpan2"> </span>
														</div>                                
														<div class="form_box filed">
															<input type="password" id="memberPwd" name="memberPwd" placeholder="비밀번호(숫자, 문자 포함 8자리 이상 )" required>
															<span class="noticeSpan4"></span>
														</div>
														<div class="form_box filed">
															<input type="password" id="memberPwd2" name="memberPwd2" placeholder="비밀번호 확인" required>
												...
												<article class="join_box_3 center">
													<button id="join_btn" class="button fit" onclick="return validate();">회원가입</button>
												</article>
												   <!-- 클릭 시 이용약관 모달 창 추가 -->
...
- 개인정보 주체는 개인정보의 수집 및 이용을 거부할 권리가 있으나, 공간 예약을 위한 최소한의 개인정보 수집으로서 이를 거부할 시 공간 예약이 어려울 수 있습니다.
								...
								<span class="warning">서비스 이용약관 동의는 필수입니다.</span>
															...
															<div class="modal_btn_box center">
																<div class="modal_btn">
																	<button type="button" class="button small fit"  onclick="setParent();" data-dismiss="modal">동의</button>
																</div>
																<div class="modal_btn">
